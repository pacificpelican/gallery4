      ...
      Tulips
        ...
        <?
            ...
            echo "<main class='img_holder'>";
              echo "<a class='img_link' href='". SITE_URL . "/image/" . $value['post_title'] . "'><img src='https://images.unsplash.com/photo-1464981093170-0a547e55c54c?dpr=1&auto=compress,format&fit=crop&w=2550&h=&q=80&cs=tinysrgb&crop='></img></a>";
